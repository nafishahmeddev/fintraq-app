...
- [x] **MoneyText**: `src/components/ui/MoneyText.tsx`
- [x] **TransactionRow**: `src/components/ui/TransactionRow.tsx`
- [x] **Header**: `src/components/ui/Header.tsx`
- [x] **Card**: `src/components/ui/Card.tsx`
- [x] **Typography**: `src/components/ui/Typography.tsx`
- [x] **Button**: `src/components/ui/Button.tsx`
- [x] **IconButton**: `src/components/ui/IconButton.tsx`
- [x] **ConfirmDialog**: `src/components/ui/ConfirmDialog.tsx`
- [x] **OptionsDialog**: `src/components/ui/OptionsDialog.tsx`
- [x] **IconPickerDialog**: `src/components/ui/IconPickerDialog.tsx`
- [x] **EmptyState**: `src/components/ui/EmptyState.tsx`
- [x] **Badge**: `src/components/ui/Badge.tsx`
- [x] **Input**: `src/components/ui/Input.tsx`
- [x] **KPICard**: `src/components/ui/KPICard.tsx`
- [x] **ListItem**: `src/components/ui/ListItem.tsx`
- [x] **PremiumGuard**: `src/components/ui/PremiumGuard.tsx`
- [x] **AlertModal**: `src/components/ui/AlertModal.tsx`
- [x] **Chip**: `src/components/ui/Chip.tsx`
- [x] **CurrencyPickerModal**: `src/components/ui/CurrencyPickerModal.tsx`
- [x] **Divider**: `src/components/ui/Divider.tsx`
- [x] **IconBox**: `src/components/ui/IconBox.tsx`
- [x] **PersonPickerDialog**: `src/components/ui/PersonPickerDialog.tsx`
- [x] **PlacePickerDialog**: `src/components/ui/PlacePickerDialog.tsx`
- [x] **SectionLabel**: `src/components/ui/SectionLabel.tsx`
