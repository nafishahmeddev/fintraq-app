...
export default function PremiumScreen() {
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        <View style={StyleSheet.absoluteFillObject} pointerEvents="none">
          <View style={[styles.bgCircle, { top: -100, left: -100, width: 500, height: 500, backgroundColor: colors.primary + '20' }]} />
          <View style={[styles.bgCircle, { bottom: -150, right: -150, width: 600, height: 600, backgroundColor: colors.primary + '15' }]} />
        </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={StyleSheet.absoluteFillObject} pointerEvents="none">
        <View style={[styles.bgCircle, { top: -60, left: -60, width: 340, height: 340, backgroundColor: colors.primary + '90' }]} />
        <View style={[styles.bgCircle, { top: 180, right: -110, width: 440, height: 440, backgroundColor: colors.primaryDark + '70' }]} />
        <View style={[styles.bgCircle, { bottom: -110, left: 40, width: 380, height: 380, backgroundColor: colors.primary + '85' }]} />
      </View>
      <View style={[StyleSheet.absoluteFillObject, { backgroundColor: colors.background }]} />
...
const createStyles = (colors: ThemeColors, screenWidth: number) => StyleSheet.create({
  ...
  brandingText: { fontFamily: TYPOGRAPHY.fonts.semibold, fontSize: 10, color: colors.textMuted, letterSpacing: 3 },
  ...
  proBadge: { width: 64, height: 64, borderRadius: 32, backgroundColor: colors.surface, justifyContent: 'center', alignItems: 'center', marginBottom: 24 },
