...
const AccountRow = React.memo(function AccountRow({
  ...
  return (
    <TouchableOpacity style={[{ flexDirection: 'row', alignItems: 'center', padding: theme.spacing('3.5'), gap: theme.spacing('3') }]} onPress={handlePress} activeOpacity={0.7}>
      <IconAvatar icon={resolveIcon(account.icon, 'wallet-outline')} bg={accentColor} color={colors.text} size={36} iconSize={16} />
...
const CategoryRow = React.memo(function CategoryRow({
  ...
  return (
    <TouchableOpacity style={[{ flexDirection: 'row', alignItems: 'center', padding: theme.spacing('3.5'), gap: theme.spacing('3') }]} onPress={handlePress} activeOpacity={0.7}>
      <IconAvatar icon={resolveIcon(category.icon, 'pricetag-outline')} bg={catColor} color={colors.text} size={36} iconSize={16} />
