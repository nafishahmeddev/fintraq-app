...
export const RestoreStep = React.memo(function RestoreStep({
  ...
  return (
    <View style={styles.container}>
      ...
      <BentoPressable
        style={[styles.card, isFresh && styles.cardActive, isRestoring && styles.disabledCard]}
        onPress={() => !isRestoring && onSelectOption('fresh')}
      ...
      <BentoPressable
        style={[styles.card, isRestore && styles.cardActive, isRestoring && styles.disabledCard]}
        onPress={() => !isRestoring && onSelectOption('restore')}
        disabled={isRestoring}
      >
        <View style={styles.cardMainRow}>
          <IconAvatar
