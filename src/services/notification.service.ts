...
const REMINDER_POOL = [
  ...
  { title: "Keeep OS: Action Required ⚠️", body: "A gap in your data detected. Ensure your financial ledger is up to date." },
  { title: "The Money Trail 👣", body: "Keeping track of every cent is the first step to freedom. Spend 30 seconds logging now." },
  { title: "Wallet Audit 🧐", body: "Did you buy lunch? Coffee? A small spend is still a spend. Log it in Keeep." },
